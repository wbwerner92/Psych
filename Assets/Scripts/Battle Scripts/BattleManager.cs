...
//	public GameObject battleBoardPrefab;
	...
	public RectTransform actionDisplayScrollRect;
	...
	private void ResetBattle()
	{
		...
		AddActionDisplayText("Next Round: " + battleRound);
	}
	private void UpdateRoundText()
	{
		roundText.text = "Round: " + battleRound;
	}
...
//		Debug.Log ("MaxRange: " + skill.rangeMax);
	...
	public void AddActionDisplayText(string actionText)
	{
		...
		// Reset scroll position to bottom to display new text
	...
	void Update()
	{
		if (battleActive && ControlsManager.instance.controlEvent != ControlsEvent.NONE) 
		{
			...
			if (isMoving)
			{
				...
				{
					// Move Token Down
					if (activeToken.posX > 0 && battleBoard.battleSpaces[activeToken.posX, (activeToken.posY - 1)].isActive)
						battleBoard.battleSpaces[activeToken.posX, (activeToken.posY - 1)].PerformLoadedSkill();
				}
				else
				{
