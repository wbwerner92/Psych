...
public class TestManager : MonoBehaviour 
{
	...
	public void StartTest()
	{
		...
		bod5.name = "Bod 5";
		bod5.spritePath = "Sprites/package_2";
		Bod bod6 = new Bod();
		Debug.Log ("Generated Bod: \n" + BodManager.instance.GetStats(bod6));
		bod6.name = "Bod 6";
		bod6.spritePath = "Sprites/package_2";
...
//		Skill sk1 = bod1.learnedSkills["basic_strike"];
//		Skill sk2 = bod2.learnedSkills["basic_strike"];
//		sk2.target = bod1;

//		Debug.Log ("Skill 1: " + SkillManager.instance.GetSkillInfo(sk1) + "\n" + 
//		           "Skill 2: " + SkillManager.instance.GetSkillInfo(sk2));
